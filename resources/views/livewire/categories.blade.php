<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <!-- Filters -->
    <div class="mb-6">
        <input wire:model.live.debounce.300ms="search" type="text" placeholder="Search categories..." class="w-full max-w-md px-4 py-3 text-base rounded-lg border-2 border-gray-300 dark:border-zinc-600 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 dark:bg-zinc-900/90 dark:text-white placeholder-gray-400 dark:placeholder-gray-500">
    </div>
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button onclick="confirmDelete('Are you sure you want to delete this category?', () => @this.call('delete', {{ $category->id }}))"
                            ...
                            <div class="sm:flex sm:items-start">
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div class="mt-4 space-y-4">
                                        <div>
                                            <label for="name" class="block text-base font-semibold text-gray-900 dark:text-white mb-2">Name</label>
                                            <input type="text" wire:model="name" id="name" class="mt-1 block w-full px-4 py-3 text-base rounded-lg border-2 border-gray-300 dark:border-zinc-600 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 dark:bg-zinc-900/90 dark:text-white placeholder-gray-400 dark:placeholder-gray-500" placeholder="e.g. Groceries">

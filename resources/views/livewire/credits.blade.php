<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Credits</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Track your income and credits.</p>
        </div>
    ...
    <div class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
            <input wire:model.live.debounce.300ms="search" type="text" placeholder="Search credits..."
    ...
    <div class="flex flex-col gap-4">
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-4">
                        <div
                            class="p-2 rounded-full bg-green-100 text-green-600 dark:bg-green-900/20 dark:text-green-400">
                    ...
                    <div class="text-right flex items-center gap-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button onclick="confirmDelete('Are you sure you want to delete this credit?', () => @this.call('delete', {{ $credit->id }}))"
        ...
        @if ($credits->isEmpty())
            <div class="text-center py-10">
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">No credits found</h3>
                <p class="mt-1 text-gray-500 dark:text-gray-400">Start tracking your income by adding a credit.</p>
                <div class="mt-6">
                    <button wire:click="openModal()"
                        class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150">
                        Add Credit
                                    ...
                                    <div>
                                        ...
                                        <div class="relative mt-1 rounded-lg shadow-sm">
                                            <div
                                                ...
                                                <span class="text-gray-500 text-base font-medium">{{ $currency_symbol }}</span>
                                            </div>

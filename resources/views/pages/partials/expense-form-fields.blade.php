...
<div class="space-y-4">
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="date" name="date" id="date"
                value="{{ $expense ? $expense->date->format('Y-m-d') : date('Y-m-d') }}" required class="input-field">
    ...
    <div>
        ...
        <div class="flex gap-2">
            <label class="flex-1"><input type="radio" name="classification" value="Needs" {{ old('classification', $expense?->classification ?? 'Needs') === 'Needs' ? 'checked' : '' }} class="mr-1">Needs</label>
            <label class="flex-1"><input type="radio" name="classification" value="Wants" {{ old('classification', $expense?->classification) === 'Wants' ? 'checked' : '' }} class="mr-1">Wants</label>
        </div>
    </div>
